...
class YoutubeSelectionRecyclerViewAdapter(private val items: ArrayList<YoutubeItem>) : RecyclerView.Adapter<YoutubeSelectionRecyclerViewAdapter.ViewHolder>() {

    override fun getItemCount() = items.size

    override fun onBindViewHolder(holder: YoutubeSelectionRecyclerViewAdapter.ViewHolder, position: Int) {
