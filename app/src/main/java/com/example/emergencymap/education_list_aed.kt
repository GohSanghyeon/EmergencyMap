...
class education_list_aed : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*val rabbit1 = findViewById(R.id.aed1_view) as ImageView
        ...
        for(nowPosition in 0 .. 2){
            ...
            when(nowPosition){
                0 -> {
                    Glide.with(applicationContext).load(R.drawable.aed1).into(gifImage1)
                }
                1 -> {
                    Glide.with(applicationContext).load(R.drawable.aed2).into(gifImage1)
                }
                2 -> {
                    Glide.with(applicationContext).load(R.drawable.aed3).into(gifImage1)
                }
            }
